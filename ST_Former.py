...
from weight_init import (trunc_normal_, init_from_vit_pretrain_,init_from_mae_pretrain_, init_from_kinetics_pretrain_)
...
class TimeSformer(nn.Module):
    ...
    def __init__(self,
        ...
        if self.attention_type == 'divided_space_time':
            ...
            # operator_order = ['time_attn', 'ffn','space_attn', 'ffn']
            operator_order = ['time_attn', 'ffn','space_attn', 'ffn']
...
if __name__ == '__main__':
	...
	model = TimeSformer(num_frames=16,
						img_size=7,
						patch_size=1,
						attention_type='divided_space_time',
						use_learnable_pos_emb=True,
						return_cls_token=True)
	input = torch.rand(1,16,256,7,7)
